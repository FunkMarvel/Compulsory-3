...
#define UE_PROJECT_NAME SpaceInvader
#define UE_TARGET_NAME SpaceInvaderEditor
#define UE_MODULE_NAME "SpaceInvader"
...
#define SPACEINVADER_API DLLEXPORT
